...
local Window = OrionLib:MakeWindow({Name = "Quish Hub | DOORS 👁️", HidePremium = true, IntroEnabled = true, IntroText = "Quish Hub", SaveConfig = true, ConfigFolder = "QuishConfig"})
...
-- Labels
CharTab:AddLabel("Local Player Stuff")
...
-- Labels
VisualsTab:AddLabel("Main Stuff")
