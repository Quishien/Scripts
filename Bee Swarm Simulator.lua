...
local Window = OrionLib:MakeWindow({Name = "Quish Hub | Bee Swarm Simulator", HidePremium = true, IntroEnabled = true, IntroText = "Quish Hub", SaveConfig = true, ConfigFolder = "QuishConfig"})
...
local Dispenser = Window:MakeTab({
	Name = "Dispensers",
	Icon = "rbxassetid://11627277857",
	PremiumOnly = false
})
local Use = Window:MakeTab({
	Name = "Dices",
	Icon = "rbxassetid://11627277852",
	PremiumOnly = false
})
local Boosts = Window:MakeTab({
	Name = "Boosts",
	Icon = "rbxassetid://11627277859",
	PremiumOnly = false
})
local Use2 = Window:MakeTab({
	Name = "Use Buffs",
	Icon = "rbxassetid://11627277854",
	PremiumOnly = false
})
...
local Mobs = Window:MakeTab({
	Name = "Combat",
	Icon = "rbxassetid://11627277865",
	PremiumOnly = false
})
local Mask = Window:MakeTab({
    Name = "Masks",
    Icon = "rbxassetid://11627277849",
    PremiumOnly = false
})
...
Main:AddLabel("Main Stuff")
Dispenser:AddLabel("Main Stuff")
Use:AddLabel("Main Stuff")
Boosts:AddLabel("Main Stuff")
Use2:AddLabel("Main Stuff")
Tp12:AddLabel("Teleports in game")
Mobs:AddLabel("Main Stuff")
Mask:AddLabel("Main Stuff")
Visuanal:AddLabel("Main Visuals")
...
Dispenser:AddLabel("Other Stuff")
...
while player.CoreStats.Pollen.Value>=maxpollen do 
    wait()
    if player.CoreStats.Pollen.Value > 99 then
        wait(0.1)
...
Commandopad.Position = Vector3.new(520.56, 55.1981, 162.801)
wait(0.1)
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(520.56, 55.1981, 162.801)
  	end    
})
Mobs:AddButton({
...
Mobs:AddLabel("Other Stuff")

Mobs:AddButton({
    Name = "Keep teleporting to Windy",
    allback = function()
...
Visuanal:AddLabel("Other Visuals")
...
Visuanal:AddToggle({
    ...
    local UpdateTab = Window:MakeTab({
     ...
     -- LABELS
     UpdateTab:AddLabel("11/21/2022")
    
     -- PARAGRAPHS
     UpdateTab:AddParagraph("Updates","Made this huge script. Fixed the auto farm and improved it.")
